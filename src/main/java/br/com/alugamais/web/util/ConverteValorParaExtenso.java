...
public class ConverteValorParaExtenso {
    ...
    public ConverteValorParaExtenso() {
        nro = new ArrayList();
    }

    public ConverteValorParaExtenso(BigDecimal dec) {
        this();
        setNumber(dec);
    }

    public ConverteValorParaExtenso(double dec) {
        this();
        setNumber(dec);
    }
    ...
    public void show() {
        ...
        while (valores.hasNext()) {
            System.out.println(((Number) valores.next()).intValue());
        }
    ...
    private boolean ehPrimeiroGrupoUm() {
        if (((Number) nro.get(nro.size() - 1)).intValue() == 1) {
            return true;
        }
        return false;
    }
